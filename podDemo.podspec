...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shendy1991/podDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shendeyuan' => 'shendeyuan@souche.com' }
  s.source           = { :git => 'https://github.com/shendy1991/podDemo.git', :tag => s.version.to_s }
